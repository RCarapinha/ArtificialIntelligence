...
for i = 1:iterations
    ...
    while row > 0
        for col = 1:size(utility_matrix, 2)
            if (utility_matrix(row, col) == 100)|| (utility_matrix(row, col) == 2) || (utility_matrix(row, col) == b)
